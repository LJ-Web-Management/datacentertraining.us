...
var DC_COURSES = [
  ...
  { slug: "fiber-optics-network-cabling", id: 423, tier: "modular", category: "Monitoring & Automation", name: "Fiber Optics & Network Cabling", msrp: 99.99, duration: "3.5 hrs", standard: "ANSI/TIA-942", hook: "Terminate, test, and troubleshoot data center fiber to ANSI/TIA-942 standards." },
  { slug: "generator-operations-maintenance", id: 424, tier: "modular", category: "Power & Electrical", name: "Generator Operations & Maintenance", msrp: 99.99, duration: "3.5 hrs", standard: null, hook: "Size, test, and maintain backup generators with confidence." },
  { slug: "energy-efficiency-pue-optimization", id: 425, tier: "modular", category: "Cooling & Efficiency", name: "Energy Efficiency & PUE Optimization", msrp: 99.99, duration: "3 hrs", standard: "PUE", hook: "Cut operating costs with a measurable PUE optimization roadmap." },
  { slug: "capacity-planning-forecasting", id: 426, tier: "modular", category: "Design & Planning", name: "Capacity Planning & Forecasting", msrp: 99.99, duration: "3.5 hrs", standard: null, hook: "Build a 3–5 year capacity plan before you run out of power, cooling, or space." },
  { slug: "preventive-maintenance-planning", id: 427, tier: "modular", category: "Operations", name: "Preventive Maintenance Planning", msrp: 99.99, duration: "3 hrs", standard: null, hook: "Reduce emergency repairs with a structured preventive maintenance program." },
  { slug: "facility-environmental-compliance", id: 428, tier: "modular", category: "Security & Compliance", name: "Facility Environmental Compliance", msrp: 99.99, duration: "3 hrs", standard: null, hook: "Understand the environmental regulations that apply to your facility." },
  ...
  { slug: "access-control-physical-security", id: 430, tier: "modular", category: "Security & Compliance", name: "Access Control & Physical Security", msrp: 99.99, duration: "3.5 hrs", standard: null, hook: "Practical security training for facility staff — access control, surveillance, and incident reporting." },
  { slug: "dcim-platform-fundamentals", id: 431, tier: "modular", category: "Monitoring & Automation", name: "DCIM Platform Fundamentals", msrp: 99.99, duration: "5 hrs", standard: "DCIM", hook: "Understand DCIM strategy and build the ROI case for implementation." },
  ...
  { slug: "electrical-safety-best-practices", id: 433, tier: "modular", category: "Power & Electrical", name: "Electrical Safety & Best Practices", msrp: 99.99, duration: "3 hrs", standard: "NFPA 70E", hook: "NFPA 70E-aligned electrical safety fundamentals for facility staff." },
  ...
  { slug: "osha-electrical-safety-data-center-technicians", id: 458, tier: "modular", category: "Power & Electrical", name: "OSHA Electrical Safety-Related Work Practices for Data Center Technicians", msrp: 99.99, duration: "2 hrs", standard: "NFPA 70E", hook: "OSHA-aligned electrical safety-related work practices tailored to data center technicians." },
